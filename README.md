...
- **[NEW]** Full Wi-Fi support (AP + STA modes).
- **[NEW]** SNTP time synchronization (in STA mode).
- **[NEW]** HTTP server with Wi-Fi configuration page.
- **[NEW]** Wi-Fi mode switching using the joystick (Left → AP, Right → STA).
- **[NEW]** WS2812 LED Wi-Fi status strategy.
...
## **[NEW]** Wi-Fi Connectivity & System Integration
...
- **[NEW]** `JOYSTICK_ENABLE_WIFI_MODE` - Enable wifi mode

### **[NEW]** WIFI_AP Configuration
...
└── components/
    ...
    ├── SNtP_sync/              # [New] SNTP time synchronization module
    ├── HTTP_server/            # [New] Embedded HTTP server for configuration
    ├── wifi_ap/                # [New] Wi-Fi Access Point mode implementation
    ├── wifi_sta/               # [New] Wi-Fi Station mode with reconnect logic
