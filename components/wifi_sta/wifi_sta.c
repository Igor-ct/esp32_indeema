                          ...
                          int32_t event_id, void* event_data)
{
    if (event_base == WIFI_EVENT && event_id == WIFI_EVENT_STA_START) {
        ...
        led2_set_wifi_state(WIFI_LED_IP_RECEIVED);
        ...
        led2_set_wifi_state(WIFI_LED_ONLINE);
        start_webserver();
}
}
...
esp_err_t wifi_init_sta(void)
{
    ...
    led2_set_wifi_state(WIFI_LED_STA_CONNECTING);
    led2_set_rgb(255,255,0);
    ...
    if (bits & WIFI_CONNECTED_BIT) {
        ...
        led2_set_wifi_state(WIFI_LED_STA_ERROR);
        return ESP_FAIL;
    }
}
